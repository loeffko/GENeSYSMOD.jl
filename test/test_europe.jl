...
model, data = @track "Europe run" genesysmod(;elmod_daystep = 20, elmod_hourstep = 4, solver=solver, DNLPsolver = Ipopt.Optimizer, threads=0,
inputdir = joinpath(pkgdir(GENeSYSMOD),"InputData"),
resultdir = TEST_RESULTS_DIR,
data_file="RegularParameters_Europe_EnVis_Green",
hourly_data_file = "Timeseries_Europe_EnVis_Green",
