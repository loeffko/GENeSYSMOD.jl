...
model, data = @track "MiddleEarth power-only run" genesysmod(;elmod_daystep = 3, 
elmod_hourstep = 1, solver=solver, DNLPsolver = Ipopt.Optimizer, threads=6,
inputdir = joinpath(pkgdir(GENeSYSMOD),"InputData"),
resultdir = TEST_RESULTS_DIR,
data_file="RegularParameters_MiddleEarth_powerOnly",
hourly_data_file = "Timeseries_MiddleEarth_powerOnly",
switch_power_only_mode = 1,
allfuels_data_file = "RegularParameters_MiddleEarth_allFuels",
